...
from app.routes import generate, lipinski, binding, admet, agent

app = FastAPI(
    title="Drug Analysis API",
    description="Comprehensive API for drug analysis and prediction",
    version="1.0.0"
)
...
async def root():
    ...
    return {
        ...
        "version": "1.0.0",
        "description": "API for drug analysis and prediction",
        "endpoints": {
